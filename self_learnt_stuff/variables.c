...
int main() {
  ...
  int another_age; // Only defined, trying to use this (without assigning)
                   // results in a compiling error
  // Both lines above could be simplified to 'int age = 18, new_age;' defining
  // both as int's and assigning one
  printf("Age: %d\n", age);
  ...
  age -= 1; // Same as 'age = age - 1;', Incrementing and decrementing can also
            // be done with 'age++' and 'age--'
